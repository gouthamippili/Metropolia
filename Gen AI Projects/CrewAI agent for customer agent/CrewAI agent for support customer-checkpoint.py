...
support_agent = Agent(
    ...
    backstory=(
        ...
        "are now working on providing support to {customer}, a super important customer "
...
support_quality_assurance_agent = Agent(
    ...
    backstory=(
        "You work at crewAI (https://crewai.com) and "
        "are now working with your team on a request from {customer} ensuring that "
...
inquiry_resolution = Task(
    ...
    expected_output=(
        ...
        "all aspects of their question. The response should include references to "
        "everything you used to find the answer, including external data or solutions. "
...
quality_assurance_review = Task(
    ...
    expected_output=(
        ...
        "relevant feedback and improvements. Maintain a professional and friendly tone throughout."
    ),
